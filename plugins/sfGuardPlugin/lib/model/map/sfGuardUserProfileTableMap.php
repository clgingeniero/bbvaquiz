...
class SfGuardUserProfileTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('ID_ZONE', 'IdZone', 'INTEGER', true, 11, null);
		$this->addColumn('EMAIL', 'Email', 'VARCHAR', true, 100, null);
		$this->addColumn('GENDER', 'Gender', 'VARCHAR', true, 10, null);
		$this->addColumn('USER_BANK_ID', 'UserBankId', 'VARCHAR', true, 45, null);
		$this->addColumn('ID_POSITION', 'IdPosition', 'INTEGER', true, 11, null);
		$this->addColumn('ID_CENTER_COST', 'IdCenterCost', 'VARCHAR', true, 45, null);
		$this->addColumn('ID_DEPTO', 'IdDepto', 'INTEGER', true, 11, null);
		$this->addColumn('ID_AREA', 'IdArea', 'INTEGER', true, 11, null);
		// validators
	} // initialize()
