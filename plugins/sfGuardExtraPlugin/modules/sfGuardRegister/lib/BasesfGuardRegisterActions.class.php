    ...
    if ($request->isMethod(sfRequest::POST))
    {
      ...
      if ($this->form->isValid())
      {
       ...
       /* if (isset($values['email']))
        ...
        $sfGuardUserProfile->setIdPosition('163');
        $sfGuardUserProfile->setIdCenterCost('1340');
        $sfGuardUserProfile->setIdDepto('671');
        $sfGuardUserProfile->setIdArea('12');
        $sfGuardUserProfile->setIdZone('1');
       ...
       /* if (isset($values['email']))
        ...
        $to = "admin@bbvacol.com";//$sfGuardUser->getEmail();
