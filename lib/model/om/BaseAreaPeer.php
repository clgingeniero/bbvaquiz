...
abstract class BaseAreaPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdArea', 'Area', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idArea', 'area', ),
		BasePeer::TYPE_COLNAME => array (self::ID_AREA, self::AREA, ),
		BasePeer::TYPE_FIELDNAME => array ('id_area', 'area', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdArea' => 0, 'Area' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idArea' => 0, 'area' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID_AREA => 0, self::AREA => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id_area' => 0, 'area' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		$criteria->addSelectColumn(AreaPeer::ID_AREA);
		$criteria->addSelectColumn(AreaPeer::AREA);
	}
	 ...
	 */
	public static function addInstanceToPool(Area $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getIdArea();
			} // if key === null
	...
	/**
	 * Method perform an INSERT on the database, given a Area or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseAreaPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseAreaPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(AreaPeer::ID_AREA) && $criteria->keyContainsValue(AreaPeer::ID_AREA) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.AreaPeer::ID_AREA.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseAreaPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseAreaPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Area or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseAreaPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseAreaPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(AreaPeer::ID_AREA);
			$selectCriteria->add(AreaPeer::ID_AREA, $criteria->remove(AreaPeer::ID_AREA), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseAreaPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseAreaPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the area table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Area or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(AreaPeer::ID_AREA, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(AreaPeer::ID_AREA, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(AreaPeer::DATABASE_NAME);
			$criteria->add(AreaPeer::ID_AREA, $pks, Criteria::IN);
