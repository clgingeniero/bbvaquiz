...
abstract class BaseAnswerPeer {
	...
	const ID_ANSWER = 'answer.ID_ANSWER';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdAnswer', 'Answer', 'IdQuestion', 'Correct', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idAnswer', 'answer', 'idQuestion', 'correct', ),
		BasePeer::TYPE_COLNAME => array (self::ID_ANSWER, self::ANSWER, self::ID_QUESTION, self::CORRECT, ),
		BasePeer::TYPE_FIELDNAME => array ('id_answer', 'answer', 'id_question', 'correct', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdAnswer' => 0, 'Answer' => 1, 'IdQuestion' => 2, 'Correct' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idAnswer' => 0, 'answer' => 1, 'idQuestion' => 2, 'correct' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID_ANSWER => 0, self::ANSWER => 1, self::ID_QUESTION => 2, self::CORRECT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id_answer' => 0, 'answer' => 1, 'id_question' => 2, 'correct' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		$criteria->addSelectColumn(AnswerPeer::ID_ANSWER);
		$criteria->addSelectColumn(AnswerPeer::ANSWER);
		$criteria->addSelectColumn(AnswerPeer::ID_QUESTION);
		$criteria->addSelectColumn(AnswerPeer::CORRECT);
	}
	...
	public static function doCountJoinQuestion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AnswerPeer::ID_QUESTION, QuestionPeer::ID_QUESTION, $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseAnswerPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseAnswerPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(AnswerPeer::ID_ANSWER) && $criteria->keyContainsValue(AnswerPeer::ID_ANSWER) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.AnswerPeer::ID_ANSWER.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseAnswerPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseAnswerPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(AnswerPeer::ID_ANSWER);
			$selectCriteria->add(AnswerPeer::ID_ANSWER, $criteria->remove(AnswerPeer::ID_ANSWER), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(AnswerPeer::ID_ANSWER, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(AnswerPeer::ID_ANSWER, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(AnswerPeer::DATABASE_NAME);
			$criteria->add(AnswerPeer::ID_ANSWER, $pks, Criteria::IN);
