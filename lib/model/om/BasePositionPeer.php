...
abstract class BasePositionPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Position';
	...
	const ID_POSITION = 'position.ID_POSITION';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdPosition', 'Position', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idPosition', 'position', ),
		BasePeer::TYPE_COLNAME => array (self::ID_POSITION, self::POSITION, ),
		BasePeer::TYPE_FIELDNAME => array ('id_position', 'position', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdPosition' => 0, 'Position' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idPosition' => 0, 'position' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID_POSITION => 0, self::POSITION => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id_position' => 0, 'position' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		$criteria->addSelectColumn(PositionPeer::ID_POSITION);
		$criteria->addSelectColumn(PositionPeer::POSITION);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BasePositionPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Position $value A Position object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Position $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getIdPosition();
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Position) {
				$key = (string) $value->getIdPosition();
	...
	{
		return $withPrefix ? PositionPeer::CLASS_DEFAULT : PositionPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Position or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePositionPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePositionPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(PositionPeer::ID_POSITION) && $criteria->keyContainsValue(PositionPeer::ID_POSITION) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.PositionPeer::ID_POSITION.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePositionPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePositionPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Position or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePositionPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePositionPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PositionPeer::ID_POSITION);
			$selectCriteria->add(PositionPeer::ID_POSITION, $criteria->remove(PositionPeer::ID_POSITION), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePositionPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePositionPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the position table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(PositionPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Position or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PositionPeer::ID_POSITION, (array) $values, Criteria::IN);
	 ...
	 */
	public static function doValidate(Position $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(PositionPeer::ID_POSITION, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PositionPeer::DATABASE_NAME);
			$criteria->add(PositionPeer::ID_POSITION, $pks, Criteria::IN);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BasePositionPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
