...
abstract class BaseArea extends BaseObject  implements Persistent {
	...
	public function setIdArea($v)
	{
		...
		if ($this->id_area !== $v) {
			$this->id_area = $v;
			$this->modifiedColumns[] = AreaPeer::ID_AREA;
		}
	...
	public function setArea($v)
	{
		...
		if ($this->area !== $v) {
			$this->area = $v;
			$this->modifiedColumns[] = AreaPeer::AREA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_area = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 2; // 2 = AreaPeer::NUM_COLUMNS - AreaPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setIdArea($pk);  //[IMV] update autoincrement primary key
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdArea($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AreaPeer::ID_AREA)) $criteria->add(AreaPeer::ID_AREA, $this->id_area);
		if ($this->isColumnModified(AreaPeer::AREA)) $criteria->add(AreaPeer::AREA, $this->area);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AreaPeer::ID_AREA, $this->id_area);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdArea(NULL); // this is a auto-increment column, so set to default value
	 ...
	 * Otherwise if this Area has previously been saved, it will retrieve
	 * related SfGuardUserProfiles from storage. If this Area is new, it will return
		...
		if ($this->collSfGuardUserProfiles === null) {
			if ($this->isNew()) {
			   $this->collSfGuardUserProfiles = array();
				...
				$criteria->add(SfGuardUserProfilePeer::ID_AREA, $this->id_area);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseArea:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseArea::%s', $method));
	  }
