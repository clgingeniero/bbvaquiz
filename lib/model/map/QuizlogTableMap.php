...
class QuizlogTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('ID_USRQL', 'IdUsrql', 'INTEGER', 'sf_guard_user_profile', 'USER_ID', true, 11, null);
    ...
    $this->addRelation('SfGuardUserProfile', 'SfGuardUserProfile', RelationMap::MANY_TO_ONE, array('id_usrql' => 'user_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
